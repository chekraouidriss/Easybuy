            ...
            <div class="col-lg-9">
                ...
                @if ($produits->isEmpty())
                    <div class="alert alert-warning">
                        Aucun produit trouvé pour "{{ request('query') }}".
                    </div>
                @else
                    <div class="row">
                        @foreach ($produits as $produit)
                            <div class="col-md-4">
                                <div class="card mb-4 product-wap rounded-0">
                                    ...
                                    <div class="card-body">
                                        <a href="shop-single" class="h3 text-decoration-none"><b>{{ $produit->Nom }}</b></a>
                                        <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                            <li>Stock: {{ $produit->QntStock }}</li>
                                        </ul>
                                        ...
                                        <p class="text-center mb-0" style="color: green;"><b>{{ $produit->Prix }} MAD</b></p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                            ...
                            <div class="carousel slide carousel-multi-item pt-2 pt-md-0" id="templatemo-slide-brand" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner product-links-wap" role="listbox">
                                    ...
                                    <div class="carousel-item active">
                                        <div class="row">
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src={{ asset('assets/img/hp.png') }} alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src={{ asset('assets/img/asus.png') }} alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src={{ asset('assets/img/lenovo.png') }} alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src={{ asset('assets/img/azur.png') }} alt="Brand Logo"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--End First slide-->
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src={{ asset('assets/img/acer.png') }} alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src={{ asset('assets/img/cisco.png') }} alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src={{ asset('assets/img/logo-mac-os.png') }} alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src={{ asset('assets/img/samsung.png') }} alt="Brand Logo"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
